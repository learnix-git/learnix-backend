...
// GET
router.get('/skills', compel, SkillController.get_skills);
router.get('/degrees', compel, DegreeController.get_degrees);
router.get('/history', compel, TutorController.get_history);
router.get('/schedule', compel, TutorController.get_schedule);

// POST
router.post('/skills', compel, SkillController.create_skill);
router.post('/degrees', compel, upload.single('file'), DegreeController.create_degree);
...
// DELETE
router.delete('/skills/:topic', compel, SkillController.delete_skill);
router.delete('/degrees/:id', compel, DegreeController.delete_degree);
